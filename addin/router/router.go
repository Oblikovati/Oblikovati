...
func (r *Router) registerStandardHandlers() {
	...
	r.readOnly(wire.MethodWorkPlanesList, typedCtx(activeWorkHost, listWorkPlanes))
	...
	r.readOnly(wire.MethodWorkPointsList, typedCtx(activeWorkHost, listWorkPoints))
	r.mutating(wire.MethodWorkPointsCreate, "Create Work Point", typedCtx(activeWorkHost, createWorkPoint))
	r.readOnly(wire.MethodWorkAxesList, typedCtx(activeWorkHost, listWorkAxes))
