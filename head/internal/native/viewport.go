...
// column-major MVP. Triangle and line vertices are interleaved [pos.xyz, normal.xyz,
// color.rgba] (10 floats); indices are 0-based within their own vertex array.
func (win *Window) RenderViewport(w, h int, mvp []float32,
