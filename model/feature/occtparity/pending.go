...
// The engine's most frequently repeated decline reasons, named so the lanes they mark are legible
// at a glance and the exact wording lives in ONE place. These are the engine's own measured strings
// — do not reword them to read better: an entry's reason must keep matching what the engine reports,
// because that is what makes this list a specification of the remaining work rather than a label.
const (
	declineCannotRoundCurvedBSpline            = "cannot round an edge bordering a curved (geom.BSplineSurface) face — rounding a filleted or otherwise curved edge is not yet supported"
	declineCannotRoundCurvedCylinder           = "cannot round an edge bordering a curved (cylinder) face — rounding a filleted or otherwise curved edge is not yet supported"
	declineCannotRoundCurvedEllipticalCylinder = "cannot round an edge bordering a curved (geom.EllipticalCylinder) face — rounding a filleted or otherwise curved edge is not yet supported"
	declineBordersCurvedCylinder               = "rounding an edge that borders a curved (cylinder) face is not yet supported"
	declineCornerFaceMustBePlanar              = "corner face must be planar"
)
...
var pendingCapability = map[quarantineKey]string{
	...
	{"bfuseblend", "B2"}:       declineCannotRoundCurvedBSpline,
	...
	{"complex", "C1"}:          declineBordersCurvedCylinder,
	...
	{"complex", "E8"}:          declineCannotRoundCurvedCylinder,
	{"complex", "F1"}:          declineBordersCurvedCylinder,
	...
	{"encoderegularity", "A4"}: declineCornerFaceMustBePlanar,
	...
	{"simple", "F5"}:           declineCornerFaceMustBePlanar,
	...
	{"simple", "G6"}:           declineCornerFaceMustBePlanar,
	...
	{"simple", "O3"}:           declineCannotRoundCurvedCylinder,
	{"simple", "O4"}:           declineCornerFaceMustBePlanar,
	...
	{"simple", "O6"}:           declineCannotRoundCurvedCylinder,
	...
	{"simple", "P6"}:           declineCannotRoundCurvedCylinder,
	{"simple", "P7"}:           declineCannotRoundCurvedCylinder,
	...
	{"simple", "R7"}:           declineBordersCurvedCylinder,
	...
	{"simple", "T5"}:           declineCannotRoundCurvedEllipticalCylinder,
	{"simple", "T8"}:           declineCannotRoundCurvedBSpline,
	{"simple", "T9"}:           "builds but fails solid validity (empty decline reason — diagnosis not yet started)",
	{"simple", "U2"}:           declineCannotRoundCurvedEllipticalCylinder,
	{"simple", "U5"}:           declineCannotRoundCurvedCylinder,
	...
	{"tolblend_simple", "B7"}:  declineCannotRoundCurvedEllipticalCylinder,
	{"tolblend_simple", "C2"}:  declineCannotRoundCurvedEllipticalCylinder,
	...
	{"tolblend_simple", "C6"}:  declineCannotRoundCurvedBSpline,
	...
	{"tolblend_simple", "C8"}:  declineCannotRoundCurvedBSpline,
