...
//
// NOTE: the analytic replacement brep.ClassifyPointTol (M48/C3 #3429) is landed but NOT yet wired
// here — the analytic classifier miscounts a valid faceted concave solid's interior (see
// exact-containment-oracle-batch). The mesh oracle stays until it is robust on faceted bodies.
