...
func sphereArmFillet(e *topo.Edge, sp geom.Sphere, pl geom.Plane, sphereFace, planeFace *topo.Face, p filletPick, res Resolution) (edgeFillet, sphereArmReject) {
	if p.varying() {
...
func sphereArmSurface(sp geom.Sphere, pl geom.Plane, outwardN math.UnitVector3, r float64, res Resolution) (geom.Torus, sphereArmReject) {
	rho := sp.Radius - r
