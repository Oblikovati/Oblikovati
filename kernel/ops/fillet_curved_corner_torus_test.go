...
func TestSolveCurvedMixedCornerM8(t *testing.T) {
	...
	c, ok := solveCurvedMixedCorner(arms, r, ResolutionForPoints([]math.Point3{math.P3(60, 50, 100), math.P3(0, 0, 0)}))
	if !ok {
...
func TestSolveCurvedMixedCornerDeclinesNon2r(t *testing.T) {
	...
	if _, ok := solveCurvedMixedCorner(arms, r, ResolutionForPoints([]math.Point3{math.P3(60, 50, 100), math.P3(0, 0, 0)})); !ok {
