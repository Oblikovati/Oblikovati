...
// resolved.
func closedEllipticConeSpan(e *topo.Edge, spine ellipticConeRimSpine, pinchFoot math.Point3, res Resolution) (ellipticConeRimSpan, bool) {
...
func openEllipticConeSpan(e *topo.Edge, spine ellipticConeRimSpine, lo, hi float64, res Resolution) (ellipticConeRimSpan, bool) {
	slack := ellipticRimEnvelopeCoef * res.Weld()
...
func openSpanTo(e *topo.Edge, spine ellipticConeRimSpine, u0, u1 float64, res Resolution) (ellipticConeRimSpan, bool) {
...
func arcEndVertexAt(e *topo.Edge, spine ellipticConeRimSpine, u float64, res Resolution) (math.Point3, bool) {
	st, ok := spine.solveStation(u)
	if !ok {
...
// into the material).
func resolveEllipticConeCanal(e *topo.Edge, spine ellipticConeRimSpine, span ellipticConeRimSpan, wallF, coneF *topo.Face, n int, res Resolution) (*ellipticConeCanal, bool) {
...
func loftEllipticConeSpan(e *topo.Edge, spine ellipticConeRimSpine, span ellipticConeRimSpan, wallF, coneF *topo.Face, n int, res Resolution) (*ellipticConeCanal, bool) {
...
func solveGatedStations(e *topo.Edge, spine ellipticConeRimSpine, span ellipticConeRimSpan, grid []float64, wallF, coneF *topo.Face, res Resolution) ([]ellipticConeStation, bool) {
