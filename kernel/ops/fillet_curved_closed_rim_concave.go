...
func concaveSphereArmSurface(sp geom.Sphere, pl geom.Plane, outwardN math.UnitVector3, r float64, res Resolution) (geom.Torus, sphereArmReject) {
...
func concaveConeArmSurface(co geom.Cone, pl geom.Plane, outwardN math.UnitVector3, r float64, res Resolution) (geom.Torus, coneArmReject) {
...
func coneOffsetTorus(co geom.Cone, apexPrime, pOff math.Point3, r float64, res Resolution) (geom.Torus, coneArmReject) {
	sinA, cosA := stdmath.Sincos(co.HalfAngle)
	a := co.AxisDir.AsVector()
...
func concaveClosedRimBandBody(body *topo.Body, ef edgeFillet, res Resolution) (*topo.Body, string) {
