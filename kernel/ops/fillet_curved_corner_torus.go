...
func solveCurvedMixedCorner(arms curvedMixedArms, r float64, res Resolution) (curvedMixedCorner, bool) {
...
func cornerRadialDir(c math.Point3, boss geom.Cylinder, res Resolution) (math.Vector3, bool) {
...
func coveFootOnCircle(fA math.Point3, cove geom.Torus, res Resolution) bool {
