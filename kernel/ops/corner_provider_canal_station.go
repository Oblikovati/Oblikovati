...
func (canalStationProvider) Build(l RailLoop, res Resolution) (CornerBlendPatch, Certificate, bool) {
...
func certifyCanalStationPatch(surf geom.BSplineSurface, loop RailLoop, dev float64, res Resolution) Certificate {
	return Certificate{
