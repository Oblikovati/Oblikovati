...
func TestTrimmedCurvedFaceArea(t *testing.T) {
	...
	mesh := tessellate.TessellateFace(f, tessellate.Quality{ChordTolerance: 1e-3})
...
func TestFullPeriodicCylinderFaceArea(t *testing.T) {
	t.Parallel()
	const r, h = 2.0, 5.0
	mesh := tessellate.TessellateFace(fullCylinderFace(t, r, h), ops.DefaultQuality())
...
func TestConeFrustumFaceArea(t *testing.T) {
	...
	mesh := tessellate.TessellateFace(fullConeFrustumFace(t, ha, v1, v2), ops.DefaultQuality())
...
func TestConeApexFaceArea(t *testing.T) {
	...
	mesh := tessellate.TessellateFace(coneApexFace(t, ha, vRim), ops.DefaultQuality())
...
func TestTrimmedCurvedFaceOutwardWinding(t *testing.T) {
	...
	cyl := f.Geometry()
	mesh := tessellate.TessellateFace(f, tessellate.Quality{ChordTolerance: 1e-2})
