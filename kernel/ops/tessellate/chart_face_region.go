...
// wrapToPeriod folds an angle onto [0, 2π). It is fold's own reduction, and lives beside its one
// caller since the tube-wrapping band loft that shared it was deleted (#3517).
