...
func ellipticalCylinderArmEdge(body *topo.Body, e *topo.Edge, p filletPick) (edgeFillet, bool) {
	...
	arm, built := ellipticCylinderArmSurface(e, ec, pl, p, ResolutionForBody(body))
	if !built {
...
func ellipticCylinderArmSurface(e *topo.Edge, ec geom.EllipticalCylinder, pl geom.Plane, p filletPick, res Resolution) (geom.Cylinder, bool) {
...
func ellipticArmAxisPoint(e *topo.Edge, ec geom.EllipticalCylinder, nP math.UnitVector3, r float64, res Resolution) (math.Point3, bool) {
...
func ellipticTangentRoot(ec geom.EllipticalCylinder, base math.Point3, dir math.UnitVector3, r float64, res Resolution) (math.Point3, bool) {
...
func tangencyTol(r float64, res Resolution) float64 { return res.Weld() * r }
