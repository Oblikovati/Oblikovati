...
func miterSeamBottomCyl(arms curvedMiterArms, hostCyl geom.Cylinder, vp math.Point3, res Resolution) (math.Point3, bool) {
...
func torusCoaxialWithHost(tor geom.Torus, host geom.Cylinder, res Resolution) bool {
