...
// (DRAWEXE-matched).
func concaveTorusHostArmSurface(host geom.Torus, capH, rhoRim, r, nDotZ, s float64, res Resolution) (geom.Torus, torusArmReject) {
...
func concaveTorusRimArmEdge(e *topo.Edge, p filletPick, res Resolution) (edgeFillet, bool, error) {
...
func concaveTorusHostTubeContact(host, arm geom.Torus, res Resolution) (math.Point3, float64, bool) {
