...
func canalArmRailBundle(set armSetback, ef edgeFillet, w cornerWeld, filletedEdges map[uint64]bool, res Resolution) (armRails, string) {
...
func reloftCanalOverCorner(sp coneCanalSpine, e *topo.Edge, xfC float64, res Resolution) geom.Surface {
...
func canalFarAndRails(sp coneCanalSpine, ef edgeFillet, capping *topo.Face, set armSetback, t0, t1 math.Point3, w cornerWeld, res Resolution) (armRunout, endSeg, endSeg, string) {
...
func canalCappingFace(ef edgeFillet, w cornerWeld, filletedEdges map[uint64]bool, res Resolution) (*topo.Face, bool, string) {
...
func snoutCapFace(sp coneCanalSpine, far *topo.Vertex, res Resolution) (*topo.Face, bool) {
	m := sp.center(0)
