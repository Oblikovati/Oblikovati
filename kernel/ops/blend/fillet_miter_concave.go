...
func curvedMiterTorusArm(e *topo.Edge, cyl geom.Cylinder, pl geom.Plane, outwardN math.UnitVector3, r float64, res tol.Resolution, conv EdgeConvexity) (geom.Surface, bool) {
...
func curvedMiterCylinderArm(e *topo.Edge, cyl geom.Cylinder, pl geom.Plane, outwardN math.UnitVector3, r float64, res tol.Resolution, conv EdgeConvexity) (geom.Surface, bool) {
	if conv == EdgeConcave {
...
func concaveTorusArmSurface(cyl geom.Cylinder, pl geom.Plane, outwardN math.UnitVector3, r, eps float64, res tol.Resolution) (geom.Torus, bool) {
...
func concaveCylinderArmSurface(e *topo.Edge, cyl geom.Cylinder, pl geom.Plane, outwardN math.UnitVector3, r float64, res tol.Resolution) (geom.Cylinder, bool) {
