...
func assertClosureGeometry(t *testing.T, dirs [3]math.UnitVector3, r float64, res opstol.Resolution) {
	t.Helper()
	angles := [3]float64{
...
func assertPerturbedRailRejected(t *testing.T, w cornerWeld, dirs [3]math.UnitVector3, res opstol.Resolution) {
	t.Helper()
...
func torusStationFixture(t *testing.T) (geom.Torus, opstol.Resolution, float64) {
	t.Helper()
