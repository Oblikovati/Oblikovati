...
// needs tol.Resolution) — checked by solveTwoCylinderBlend, mirroring cylinderHostCorner/sphereHostCorner's
...
func twoCylCornerCenter(v *topo.Vertex, cylFaces [2]*topo.Face, cylA, cylB geom.Cylinder, planeFace *topo.Face, pl geom.Plane, r float64, res tol.Resolution) (math.Point3, bool) {
...
func twoCylOffsetRadius(f *topo.Face, cyl geom.Cylinder, vp math.Point3, r float64, res tol.Resolution) (float64, bool) {
...
func twoCylCornerConsistent(c math.Point3, cylA, cylB geom.Cylinder, planeFace *topo.Face, pl geom.Plane, r float64, res tol.Resolution) bool {
	n := outwardPlaneNormal(planeFace, pl)
...
// precedent).
func cylinderAxisDistanceMatches(cyl geom.Cylinder, c math.Point3, r float64, res tol.Resolution) bool {
...
func twoCylCornerResolution(v *topo.Vertex, cylA, cylB geom.Cylinder, pl geom.Plane) tol.Resolution {
	return tol.ForPoints([]math.Point3{v.Point(), cylA.Origin, cylB.Origin, pl.Origin})
}
