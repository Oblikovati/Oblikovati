...
func TestIntersectArmCapping_D5MeridianSpiric(t *testing.T) {
	...
	curve, ok := intersectArmCapping(edgeFillet{armSurface: tor}, cap, feet, 10, opstol.ForSize(300))
	if !ok || curve == nil {
...
func TestIntersectArmCapping_PlusOneBranch(t *testing.T) {
	...
	curve, ok := intersectArmCapping(edgeFillet{armSurface: tor}, cap, feet, 10, opstol.ForSize(120))
	if !ok || curve == nil {
...
func TestIntersectArmCapping_ZeroSurvivorDeclines(t *testing.T) {
	...
	if curve, ok := intersectArmCapping(edgeFillet{armSurface: tor}, cap, feet, 10, opstol.ForSize(120)); ok || curve != nil {
