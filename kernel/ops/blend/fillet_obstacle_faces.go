...
func collectObstacles(body *topo.Body, fils []edgeFillet, res tol.Resolution,
...
func obstacleFacesFor(ef edgeFillet, res tol.Resolution, maps filletRebuildMaps) (obstacleSet, bool) {
	if ef.varying {
...
func resolveObstaclePatch(of *ObstacleFeature, res tol.Resolution) (CornerBlendPatch, bool) {
...
func dualObstacleRoute(ef edgeFillet, res tol.Resolution, maps filletRebuildMaps) (obstacleSet, bool, bool) {
