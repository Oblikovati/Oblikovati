...
func buildCurvedMiterTorusPair(ps []filletPick, r float64, res opstol.Resolution) (curvedMiterTorusPair, bool) {
	if len(ps) != 2 {
...
func torusTorusCoaxial(torA, torB geom.Torus, res opstol.Resolution) bool {
...
func torusTorusStation(pair curvedMiterTorusPair, r, z, signA, signB float64, vp math.Point3, res opstol.Resolution) (math.Point3, bool) {
	disc := r*r - z*z
	if disc < 0 {
...
func torusTorusPhysicalSign(pair curvedMiterTorusPair, res opstol.Resolution) (signA, signB float64, ok bool) {
...
func torusTorusHostSign(e *topo.Edge, tor geom.Torus, res opstol.Resolution) (float64, bool) {
...
func torusTorusSharedPlaneHeight(shared *topo.Face, torA geom.Torus, res opstol.Resolution) (float64, bool) {
...
func walkTorusTorusSeam(pair curvedMiterTorusPair, r, zTop, signA, signB float64, vp math.Point3, res opstol.Resolution) ([]math.Point3, bool) {
...
func torusTorusSeamBottomCertified(pair curvedMiterTorusPair, sBot, vp math.Point3, res opstol.Resolution) bool {
...
func solveCurvedMiterTorusPair(v *topo.Vertex, shared *topo.Face, pair curvedMiterTorusPair, r float64, res opstol.Resolution) (*cornerMiter, error) {
...
func torusTorusCertifiedSeam(pair curvedMiterTorusPair, r, zTop, signA, signB float64, v *topo.Vertex, res opstol.Resolution) ([]math.Point3, error) {
