...
func canalHostFaces(body *topo.Body, w cornerWeld, boundaries canalBoundaries, bundles []canalArmBundle, rolls []geom.Surface, res opstol.Resolution) ([]filletFace, string) {
...
func canalHostFace(f *topo.Face, boundaries canalBoundaries, bundles []canalArmBundle, rolls []geom.Surface, w cornerWeld, res opstol.Resolution, tol float64) (filletFace, string) {
