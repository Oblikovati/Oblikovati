...
func extractTangentDegenerateCorner(w cornerWeld, arms []edgeFillet, res opstol.Resolution) (RailLoop, bool) {
...
func reflectedArmCentres(w cornerWeld, arms []edgeFillet, scale float64, res opstol.Resolution) ([]math.Point3, bool, string) {
...
func seedRootArm(w cornerWeld, arms []edgeFillet, scale float64, res opstol.Resolution, centres []math.Point3, done []bool) {
	for i, a := range arms {
...
func resolveArmCentre(w cornerWeld, arms []edgeFillet, i int, centres []math.Point3, done []bool, scale float64, res opstol.Resolution) (math.Point3, bool, string) {
	tol := res.Weld() * scale
...
func wallFeetSplit(wall geom.Cylinder, centres []math.Point3, wa [2]int, res opstol.Resolution, scale float64) bool {
