...
func equalParallelCylMiterArm(e *topo.Edge, r float64, res opstol.Resolution, conv EdgeConvexity) (geom.Surface, bool) {
	faces := e.Faces()
	if len(faces) != 2 {
		return nil, false
	}
...
func equalParallelArmRuling(e *topo.Edge, cA, cB geom.Cylinder, r float64, res opstol.Resolution, conv EdgeConvexity) (math.Point3, math.Vector3, bool) {
...
func intersectCoplanarCircles(c1 math.Point3, r1 float64, c2 math.Point3, r2 float64, n math.Vector3, res opstol.Resolution) (math.Point3, math.Point3, bool) {
	w := c1.VectorTo(c2)
...
func cylCylMiterArmEdge(body *topo.Body, e *topo.Edge, p filletPick) (edgeFillet, bool) {
	...
	arm, ok := equalParallelCylMiterArm(e, p.r0, opstol.ForBody(body), EdgeConvex)
	if !ok {
