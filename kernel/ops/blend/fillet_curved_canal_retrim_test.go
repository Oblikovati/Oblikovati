...
func n7CanalBiteInputs(t *testing.T, w cornerWeld, arms []edgeFillet, res opstol.Resolution) ([]canalArmBundle, canalBoundaries, []geom.Surface) {
	t.Helper()
...
func TestCanalHostFaces_FarRunoutVerbatim(t *testing.T) {
	...
	assertSameLoopPoints(t, gotPlain[0], transformFace(plain, faceFilletInputs{}), "pass-through")
}
