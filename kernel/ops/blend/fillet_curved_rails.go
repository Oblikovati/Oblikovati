...
// rule is honoured without threading a opstol.Resolution into this pure constructor; 1e-6 rejects a
...
func curvedRailG1(arm geom.Surface, rail geom.Arc3d, center math.Point3, r float64, res opstol.Resolution) bool {
