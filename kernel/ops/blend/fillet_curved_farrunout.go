...
func curvedHostFaces(body *topo.Body, arms []edgeFillet, bundles []armRails, w cornerWeld, res opstol.Resolution) ([]filletFace, string) {
...
func curvedHostFace(f *topo.Face, corner map[*topo.Face]bool, arms []edgeFillet, bundles []armRails, w cornerWeld, res opstol.Resolution, tol float64, conns []cornerConnector) (filletFace, string) {
	if corner[f] {
