...
func extractSetbackPatches(b setbackBands, ef edgeFillet, res tol.Resolution) ([]RailLoop, bool) {
...
func buildSetbackLoops(builders []func() (RailLoop, bool), res tol.Resolution) ([]RailLoop, bool) {
...
func resolveSetbackTiling(b setbackBands, ef edgeFillet, res tol.Resolution) (setbackTiling, bool) {
...
func resolveSingleBossTiling(b setbackBands, ef edgeFillet, res tol.Resolution) (setbackTiling, bool) {
	boss := b.bosses[0]
