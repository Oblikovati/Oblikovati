...
func collectRunouts(body *topo.Body, fils []edgeFillet, res tol.Resolution,
...
func runoutFacesFor(ef edgeFillet, res tol.Resolution, maps filletRebuildMaps) (runoutSet, bool) {
	if ef.varying {
