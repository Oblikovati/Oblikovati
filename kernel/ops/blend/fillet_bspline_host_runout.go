...
func bsplineHostRunoutBody(body *topo.Body, ef edgeFillet, canal *bsplineHostCanal, res opstol.Resolution) (*topo.Body, string) {
	if canal.concave {
...
func bsplineHostEnvelopeBound(res opstol.Resolution) float64 {
	return bsplineHostEnvelopeCoef * res.Weld()
}
...
func bsplineHostResolveEnds(ef edgeFillet, canal *bsplineHostCanal, res opstol.Resolution) (end0, end1 bsplineHostEndTrim, reason string) {
...
func bsplineHostSolveEnd(ef edgeFillet, canal *bsplineHostCanal, v *topo.Vertex, vp []float64, iLo, iHi int, res opstol.Resolution) (bsplineHostEndTrim, string) {
...
func bsplineHostRunoutFaces(body *topo.Body, ef edgeFillet, canal *bsplineHostCanal, railA, railB endSeg, end0, end1 bsplineHostEndTrim, res opstol.Resolution) ([]filletFace, string) {
