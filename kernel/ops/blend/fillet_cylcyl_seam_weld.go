...
func cylCylSeamGroupBody(body *topo.Body, band *cylCylSeamBand, res opstol.Resolution) (*topo.Body, string) {
	if len(band.group) == 0 {
...
func rebuildLocatedCylCylSeam(body *topo.Body, pick cylCylSeamOpPick, res opstol.Resolution) (*topo.Body, string) {
...
func rebuildCylCylValleyLine(body *topo.Body, e *topo.Edge, r float64, res opstol.Resolution) (*topo.Body, string) {
