...
func circleCylinderFoot(c geom.Circle, cyl geom.Cylinder, near math.Point3, res tol.Resolution) (math.Point3, bool) {
...
func circleCylinderFootParallel(c geom.Circle, cyl geom.Cylinder, e1, e2 math.Vector3, near math.Point3, res tol.Resolution) (math.Point3, bool) {
