...
func setbackSection(zStation float64, dets []obstacleDetection, ef edgeFillet, res tol.Resolution) (geom.Curve3, bool) {
...
// non-arc.
func coreSectionStation(z float64, dets []obstacleDetection, ef edgeFillet, res tol.Resolution) (center, footA, footB math.Point3, ok bool) {
