...
func TestConeCornerWeldWatertight(t *testing.T) {
	...
	for _, fx := range coneWeldFixtures() {
		t.Run(fx.name, func(t *testing.T) {
			...
			if vol := tessellate.MeshGeometryProperties(mustTessellate(t, welded)).Volume; vol <= 0 {
...
func TestConeCornerGirardArea(t *testing.T) {
	...
	for _, fx := range coneWeldFixtures() {
		t.Run(fx.name, func(t *testing.T) {
			...
			area := tessellate.MeshGeometryProperties(mesh).Area
...
func TestConeCornerWholeArea(t *testing.T) {
	...
	for _, fx := range coneWeldFixtures() {
		t.Run(fx.name, func(t *testing.T) {
			welded := weldConeCornerFixture(t, fx)
			area := tessellate.MeshGeometryProperties(mustTessellate(t, welded)).Area
