...
func (s coneCanalSpring) canalCapFoot(capping geom.Surface, near math.Point3, res opstol.Resolution) (math.Point3, bool, string) {
...
func (s coneCanalSpring) canalCapFootStation(capping geom.Surface, near math.Point3, res opstol.Resolution) (math.Point3, float64, bool, string) {
...
func (s coneCanalSpring) capFootRadial(pl geom.Plane, res opstol.Resolution) (math.Point3, float64, bool, string) {
	sp := s.spine
	n := pl.Normal()
...
func canalCappingTrim(sp coneCanalSpine, capping geom.Surface, feet [2]math.Point3, r float64, res opstol.Resolution) (geom.Curve3, bool, string) {
	_ = r
	pl, ok := capping.(geom.Plane)
	if !ok {
...
func canalSnoutTrim(sp coneCanalSpine, pl geom.Plane, feet [2]math.Point3, res opstol.Resolution) (geom.Curve3, bool, string) {
	m := sp.center(0)
...
func canalPerpAxisTrim(sp coneCanalSpine, pl geom.Plane, feet [2]math.Point3, res opstol.Resolution) (geom.Curve3, bool, string) {
...
func planeFootIndex(sp coneCanalSpine, feet [2]math.Point3, res opstol.Resolution) (int, bool) {
	tol := res.Weld() * sp.radius
...
func springCapFootReasoned(spring geom.Curve3, capping geom.Surface, near math.Point3, res opstol.Resolution) (math.Point3, bool, string) {
...
func capTrimDeclineReason(ef edgeFillet, capping geom.Surface, feet [2]math.Point3, r float64, res opstol.Resolution) string {
