...
func sphereHostCornerCenter(sph geom.Sphere, sphereFace *topo.Face, planes [2]*topo.Face, r float64, v *topo.Vertex, res tol.Resolution) (math.Point3, bool) {
...
func sphereCornerRho(sph geom.Sphere, sphereFace *topo.Face, v *topo.Vertex, r float64, res tol.Resolution) (float64, bool) {
...
func sphereLineParam(sph geom.Sphere, p0 math.Point3, d math.Vector3, rho float64, vertex math.Point3, res tol.Resolution) (float64, bool) {
...
func sphereRootsSeparated(qa, qb, qc float64, d math.Vector3, res tol.Resolution) bool {
	disc := qb*qb - 4*qa*qc
	if disc <= 0 {
		return false
	}
...
func sphereCornerRoot(v *topo.Vertex, r float64, res tol.Resolution, c0 math.Point3) (math.Point3, bool) {
...
func sphereCornerConsistent(c math.Point3, sph geom.Sphere, planes [2]*topo.Face, r float64, res tol.Resolution) bool {
...
func sphereCornerResolution(v *topo.Vertex, sph geom.Sphere, planes [2]*topo.Face) tol.Resolution {
