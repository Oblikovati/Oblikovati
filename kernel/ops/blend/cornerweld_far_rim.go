...
func rimContinuationLinks(first cornerArmLink, arm geom.Surface, plan cornerWeldPlan, res opstol.Resolution) ([]cornerArmLink, string) {
...
func rimContinuationLink(cur cornerArmLink, arm geom.Surface, plan cornerWeldPlan, res opstol.Resolution) (cornerArmLink, string) {
...
func rimContinuationCandidate(cur cornerArmLink, e *topo.Edge, arm geom.Surface, plan cornerWeldPlan, res opstol.Resolution) (cornerArmLink, bool) {
...
func rimBallStillTangent(cur cornerArmLink, hostA, hostB *topo.Face, arm geom.Surface, plan cornerWeldPlan, res opstol.Resolution) bool {
