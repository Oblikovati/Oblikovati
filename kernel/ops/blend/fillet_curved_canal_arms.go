...
func canalArmFaces(arms []edgeFillet, w cornerWeld, b canalBoundaries, centres []math.Point3, scale float64, res opstol.Resolution) ([]filletFace, string) {
...
func canalOneArmFace(arm edgeFillet, centre math.Point3, b canalBoundaries, i, mid int, w cornerWeld, scale float64, res opstol.Resolution) (filletFace, string) {
...
func canalArmFace(arm edgeFillet, centre math.Point3, cornerRail geom.Curve3, cornerRev bool, w cornerWeld, scale float64, res opstol.Resolution) (filletFace, bool) {
...
func canalArmHostRails(arm edgeFillet, set armSetback, wi cornerWeld, res opstol.Resolution) (endSeg, endSeg, bool) {
