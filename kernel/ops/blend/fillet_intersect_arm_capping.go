...
func intersectArmCapping(ef edgeFillet, capping geom.Surface, feet [2]math.Point3, r float64, res opstol.Resolution) (geom.Curve3, bool) {
...
func armCapTol(a, b, c, d math.Point3) float64 {
	return opstol.ForPoints([]math.Point3{a, b, c, d}).Weld()
}
...
func cylinderCappingTrim(cyl geom.Cylinder, capping geom.Surface, feet [2]math.Point3, res opstol.Resolution) (geom.Curve3, bool) {
	if pl, ok := capping.(geom.Plane); ok {
...
func cylinderPlaneTrim(cyl geom.Cylinder, pl geom.Plane, feet [2]math.Point3, res opstol.Resolution) (geom.Curve3, bool) {
