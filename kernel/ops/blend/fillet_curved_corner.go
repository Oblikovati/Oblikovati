...
func curvedCornerCenter(cyl geom.Cylinder, planes [2]*topo.Face, r, eps float64, v *topo.Vertex, res tol.Resolution) (math.Point3, bool) {
...
func selectCornerRoot(cyl geom.Cylinder, planes [2]*topo.Face, r float64, v *topo.Vertex, c0 math.Point3, res tol.Resolution) (math.Point3, bool) {
...
func cornerCylinderArms(v *topo.Vertex, r float64, res tol.Resolution) []cornerArm {
	var arms []cornerArm
...
func rootStationsInDomain(arms []cornerArm, vp math.Point3, c math.Point3, scale float64, res tol.Resolution) bool {
	for _, a := range arms {
...
func curvedCornerConsistent(c math.Point3, cyl geom.Cylinder, planes [2]*topo.Face, r, eps float64, res tol.Resolution) bool {
...
func curvedCornerResolution(v *topo.Vertex, cyl geom.Cylinder, planes [2]*topo.Face) tol.Resolution {
