...
func runoutFixture(t *testing.T, radius float64) (edgeFillet, tol.Resolution) {
	t.Helper()
...
func runoutFixtureBehindBand(t *testing.T) (edgeFillet, tol.Resolution) {
	t.Helper()
