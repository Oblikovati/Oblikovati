...
// alongside its resolved edgeFillet list (always len 1 for U4) and the shared opstol.Resolution — the common
...
func u4Fillet(t *testing.T) (*topo.Body, []edgeFillet, opstol.Resolution) {
	t.Helper()
	body := importU4(t)
...
func u4EdgeFillet(t *testing.T) (edgeFillet, opstol.Resolution) {
	t.Helper()
