...
func buildDualPanelFaces(ef edgeFillet, dets []obstacleDetection, panels []panelSpan, res tol.Resolution) ([]filletFace, bool) {
...
func dualPanelBoundary(span panelSpan, dets []obstacleDetection, detA, detB obstacleDetection, ef edgeFillet, res tol.Resolution) (filletLoop, bool) {
...
func panelASideSeg(span panelSpan, detA, detB obstacleDetection, ef edgeFillet, res tol.Resolution) (ringSeg, bool) {
	if span.hostA {
...
func panelBSideSeg(span panelSpan, detB obstacleDetection, ef edgeFillet, res tol.Resolution) (ringSeg, bool) {
...
func panelEndSeg(span panelSpan, z float64, dets []obstacleDetection, detA, detB obstacleDetection, ef edgeFillet, res tol.Resolution, reverse bool) (ringSeg, bool) {
...
func seamSeg(z float64, dets []obstacleDetection, ef edgeFillet, res tol.Resolution, aC, bC math.Point3) (ringSeg, bool) {
...
func dipRimSubArcSnapped(det obstacleDetection, ef edgeFillet, zLo, zHi float64, res tol.Resolution) ([]math.Point3, bool) {
