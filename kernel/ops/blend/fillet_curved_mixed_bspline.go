...
func solveN4Corner(arms n4MixedArms, r float64, res opstol.Resolution) (n4Corner, bool) {
...
func assembleN4Corner(pts cornerCanalPts, arms n4MixedArms, vplane geom.Plane, boss geom.Cylinder, r float64, res opstol.Resolution) (n4Corner, bool) {
...
func cornerCanalPatch(surf geom.BSplineSurface, pts cornerCanalPts, railBC, railDA geom.Curve3, ring cornerCanalRing, res opstol.Resolution) (CornerBlendPatch, bool) {
...
// cracked weld.
func certifyCornerCanalPatch(surf geom.BSplineSurface, loop RailLoop, hosts []geom.Surface, res opstol.Resolution) Certificate {
	crease := 0.0
