...
func torusSpherePlaneSprings(t geom.Torus, sp geom.Sphere, pl geom.Plane) ([2]geom.Curve3, bool) {
	tol := opstol.ForPoints([]math.Point3{t.Center, sp.Center, pl.Origin}).Weld()
...
func torusCylinderPlaneSprings(t geom.Torus, cyl geom.Cylinder, pl geom.Plane) ([2]geom.Curve3, bool) {
	tol := opstol.ForPoints([]math.Point3{t.Center, cyl.Origin, pl.Origin}).Weld()
...
func springCapFoot(spring geom.Curve3, capping geom.Surface, near math.Point3, res opstol.Resolution) (math.Point3, bool) {
...
func springPlaneFoot(spring geom.Curve3, pl geom.Plane, near math.Point3, res opstol.Resolution) (math.Point3, bool) {
...
func springCylinderFoot(spring geom.Curve3, cyl geom.Cylinder, near math.Point3, res opstol.Resolution) (math.Point3, bool) {
...
func circlePlaneFoot(c geom.Circle, pl geom.Plane, near math.Point3, res opstol.Resolution) (math.Point3, bool) {
	n := pl.Normal()
