...
// spurious material-side (convex mirror) root by the void gate brep.PointInside(centre)==false plus
...
func concaveCurvedArmFillet(body *topo.Body, e *topo.Edge, cyl geom.Cylinder, pl geom.Plane, p filletPick, res opstol.Resolution, concave ConcaveFill) (edgeFillet, bool, error) {
...
func concaveTorusArmEdge(e *topo.Edge, cyl geom.Cylinder, pl geom.Plane, r float64, res opstol.Resolution) (edgeFillet, bool, error) {
...
func concaveCylinderArmEdge(body *topo.Body, e *topo.Edge, cyl geom.Cylinder, pl geom.Plane, p filletPick, res opstol.Resolution) (edgeFillet, bool, error) {
...
func concaveCylinderArmCandidates(e *topo.Edge, cyl geom.Cylinder, pl geom.Plane, planeN math.UnitVector3, r float64, res opstol.Resolution) (plus, minus geom.Cylinder, err error) {
...
func concaveArmOffsetRadius(e *topo.Edge, cyl geom.Cylinder, r float64, res opstol.Resolution) (float64, error) {
...
func selectConcaveArmRoot(body *topo.Body, e *topo.Edge, cyl geom.Cylinder, pl geom.Plane, plus, minus geom.Cylinder, r float64, res opstol.Resolution) (geom.Cylinder, bool) {
...
func concaveArmRootValid(body *topo.Body, e *topo.Edge, arm, cyl geom.Cylinder, pl geom.Plane, r float64, res opstol.Resolution) bool {
	centre, ok := armBallCenter(arm, edgeMidpoint(e))
	if !ok || brep.PointInside(body, centre) {
