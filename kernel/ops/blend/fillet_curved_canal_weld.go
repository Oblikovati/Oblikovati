...
func canalArmBody(body *topo.Body, arms []edgeFillet, blends map[uint64]*cornerBlend, vid uint64, res tol.Resolution) (*topo.Body, string, bool) {
	cb, ok := blends[vid]
	if !ok {
...
func canalWeldFaces(body *topo.Body, arms []edgeFillet, w cornerWeld, loop RailLoop, res tol.Resolution) ([]filletFace, string) {
...
func canalWeldContext(loop RailLoop, w cornerWeld, arms []edgeFillet, res tol.Resolution) (CornerBlendPatch, canalBoundaries, []math.Point3, float64, string) {
...
func canalArmBundles(arms []edgeFillet, w cornerWeld, centres []math.Point3, scale float64, res tol.Resolution) ([]canalArmBundle, bool) {
...
func canalArmBundle1(arm edgeFillet, centre math.Point3, w cornerWeld, scale float64, res tol.Resolution) (canalArmBundle, bool) {
