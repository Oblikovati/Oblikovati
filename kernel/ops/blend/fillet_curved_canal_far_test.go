...
func n7RealArms(t *testing.T) (cornerWeld, []edgeFillet, []math.Point3, canalBoundaries, float64, opstol.Resolution) {
	t.Helper()
...
func armTermini(t *testing.T, arm edgeFillet, centre math.Point3, w cornerWeld, scale float64, res opstol.Resolution) (endSeg, endSeg, endSeg) {
	t.Helper()
