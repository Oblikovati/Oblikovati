...
func extractPanelLoop(span panelSpan, dets []obstacleDetection, ef edgeFillet, res tol.Resolution) (RailLoop, bool) {
...
func buildSliverLoop(ef edgeFillet, res tol.Resolution, dets []obstacleDetection,
