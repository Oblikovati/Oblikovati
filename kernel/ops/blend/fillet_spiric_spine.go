...
func spiricMeridianCut(nDotZ, rhoRim float64, res tol.Resolution) bool {
...
func assembleSpiricSpine(e *topo.Edge, host geom.Torus, hostFace *topo.Face, n math.UnitVector3, capD, r float64, res tol.Resolution, requireClosedLoop bool) (spiricRimSpine, bool) {
