...
func curvedHostArc(host geom.Surface, tor geom.Torus, w cornerWeld, res opstol.Resolution) (geom.Arc3d, bool) {
...
func torusContactCircle(host geom.Surface, tor geom.Torus, res opstol.Resolution) (math.Point3, float64, bool) {
	switch h := host.(type) {
	case geom.Cylinder:
...
func coneContactCircle(co geom.Cone, tor geom.Torus, res opstol.Resolution) (math.Point3, float64, bool) {
...
func sphereContactCircle(sph geom.Sphere, tor geom.Torus, res opstol.Resolution) (math.Point3, float64, bool) {
...
func wallContactCircle(cyl geom.Cylinder, tor geom.Torus, res opstol.Resolution) (math.Point3, float64, bool) {
...
func capContactCircle(pl geom.Plane, tor geom.Torus, res opstol.Resolution) (math.Point3, float64, bool) {
...
func retrimCurvedHost(host *topo.Face, edges []edgeFillet, bundles []armRails, w cornerWeld, res opstol.Resolution, conns []cornerConnector) (filletFace, bool) {
...
func retrimHostSegs(host *topo.Face, segs []endSeg, edges []edgeFillet, bundles []armRails, w cornerWeld, res opstol.Resolution, conns []cornerConnector) ([]endSeg, bool) {
	tol := res.Weld() * w.radius
