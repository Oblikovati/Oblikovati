...
func coneHostCornerCenter(co geom.Cone, coneFace *topo.Face, planes [2]*topo.Face, r float64, v *topo.Vertex, res tol.Resolution) (math.Point3, float64, bool) {
...
func coneAlphaInBand(co geom.Cone, p0 math.Point3, sinA, cosA float64, res tol.Resolution) bool {
...
func coneCornerParam(qa, qb, qc float64, u, d, ahat math.Vector3, p0, vertex math.Point3, res tol.Resolution) (float64, bool) {
...
func coneRealRoots(qa, qb, qc float64, d math.Vector3, res tol.Resolution) ([]float64, bool) {
	dd := float64(d.Dot(d))
...
func coneCornerRoot(v *topo.Vertex, r float64, res tol.Resolution, c0 math.Point3) (math.Point3, bool) {
...
func coneCornerConsistent(c math.Point3, co geom.Cone, planes [2]*topo.Face, r, s float64, res tol.Resolution) bool {
...
func coneCornerResolution(v *topo.Vertex, co geom.Cone, planes [2]*topo.Face) tol.Resolution {
