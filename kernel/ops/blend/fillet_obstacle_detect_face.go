...
func detectObstacle(ef edgeFillet, res opstol.Resolution) (obstacleDetection, bool) {
...
func detectObstacles(ef edgeFillet, res opstol.Resolution) ([]obstacleDetection, bool) {
...
func straightFilletEdge(ef edgeFillet, res opstol.Resolution) bool {
	c := ef.edge.Geometry()
...
func detectObstacleOnHost(ef edgeFillet, host *topo.Face, hostIsA bool, res opstol.Resolution) (obstacleDetection, bool) {
...
func crossingDetection(ef edgeFillet, host *topo.Face, hostIsA bool, pl geom.Plane,
	holeEdge *topo.Edge, res opstol.Resolution) (obstacleDetection, bool) {
...
func bandCrossings(ef edgeFillet, hostIsA bool, pl geom.Plane, fp *topo.Edge, res opstol.Resolution) (
