...
func armFarRunout(ef edgeFillet, w cornerWeld, h0, h1 endSeg, filletedEdges map[uint64]bool, res opstol.Resolution) (endSeg, endSeg, armRunout, bool, string) {
	if ef.edge == nil {
...
func obliqueRunout(ef edgeFillet, capping *topo.Face, h0, h1 endSeg, r float64, res opstol.Resolution) (endSeg, endSeg, armRunout, bool, string) {
