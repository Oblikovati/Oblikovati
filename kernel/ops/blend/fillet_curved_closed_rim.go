...
func convexClosedRimBandBody(body *topo.Body, ef edgeFillet, res tol.Resolution) (*topo.Body, string) {
...
func solveClosedRimBand(ef edgeFillet, res tol.Resolution) (*rimFillet, string) {
...
func assembleRimBand(ef edgeFillet, devF, capF *topo.Face, tor geom.Torus, ref math.UnitVector3, rimV *topo.Vertex, res tol.Resolution) (*rimFillet, string) {
