...
func curvedFilletError(e *topo.Edge, cyl geom.Cylinder, pl geom.Plane, res tol.Resolution) error {
...
func curvedArmFillet(e *topo.Edge, cyl geom.Cylinder, pl geom.Plane, p filletPick, res tol.Resolution) (edgeFillet, bool) {
