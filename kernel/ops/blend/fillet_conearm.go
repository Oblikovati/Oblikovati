...
func classifyConeArm(co geom.Cone, pl geom.Plane, rEdge float64, res tol.Resolution) coneArmClass {
...
func coneArmSurface(co geom.Cone, pl geom.Plane, outwardN math.UnitVector3, s, r float64, res tol.Resolution) (geom.Torus, coneArmReject) {
...
func coneArmFillet(e *topo.Edge, co geom.Cone, pl geom.Plane, coneFace, planeFace *topo.Face, p filletPick, res tol.Resolution) (edgeFillet, coneArmReject) {
	if p.varying() {
...
// added.
func coneArmFilletConvex(e *topo.Edge, co geom.Cone, pl geom.Plane, n math.UnitVector3, r float64, res tol.Resolution) (edgeFillet, coneArmReject) {
...
func coneArmFilletConcave(e *topo.Edge, co geom.Cone, pl geom.Plane, n math.UnitVector3, r float64, res tol.Resolution) (edgeFillet, coneArmReject) {
	tor, reason := coneArmSurface(co, pl, n, -1, r, res)
	if reason != coneArmBuilt {
		return edgeFillet{}, reason
	}
