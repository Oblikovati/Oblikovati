...
func torusCornerCenterOnLine(v *topo.Vertex, tor geom.Torus, p0 math.Point3, d math.Vector3, rho, r float64, res tol.Resolution) (math.Point3, bool) {
...
func torusPhysicalCandidates(tor geom.Torus, p0 math.Point3, d math.Vector3, rho float64, res tol.Resolution) ([]math.Point3, bool) {
...
func torusTangencyRoots(tor geom.Torus, p0 math.Point3, d math.Vector3, rho float64, res tol.Resolution) []float64 {
...
func torusCornerTiebreak(arms []cornerArm, vp math.Point3, r float64, res tol.Resolution, cands []math.Point3) (math.Point3, bool) {
	if len(arms) == 0 {
