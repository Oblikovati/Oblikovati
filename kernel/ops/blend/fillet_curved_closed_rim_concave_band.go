...
func solveConcaveClosedRimBand(ef edgeFillet, res tol.Resolution) (*rimFillet, string) {
...
func assembleConcaveRimBand(ef edgeFillet, devF, capF *topo.Face, tor geom.Torus, ref math.UnitVector3, rimV *topo.Vertex, res tol.Resolution) (*rimFillet, string) {
...
func concaveTorusContactCircle(host geom.Surface, tor geom.Torus, res tol.Resolution) (math.Point3, float64, bool) {
	switch h := host.(type) {
	case geom.Plane:
...
func concaveSphereContactCircle(sph geom.Sphere, tor geom.Torus, res tol.Resolution) (math.Point3, float64, bool) {
...
func concaveConeContactCircle(co geom.Cone, tor geom.Torus, res tol.Resolution) (math.Point3, float64, bool) {
