...
func torusLatitudeCut(nDotZ, rhoRim float64, res tol.Resolution) bool {
...
func torusBranchSign(rhoRim, majorR float64, res tol.Resolution) float64 {
...
func torusHostArmSurface(host geom.Torus, capH, rhoRim, r, nDotZ float64, res tol.Resolution) (geom.Torus, torusArmReject) {
...
func torusHostContactCircle(host, arm geom.Torus, res tol.Resolution) (math.Point3, float64, bool) {
...
func torusArmFillet(e *topo.Edge, host geom.Torus, pl geom.Plane, planeFace *topo.Face, p filletPick, res tol.Resolution) (edgeFillet, torusArmReject) {
	if p.varying() {
