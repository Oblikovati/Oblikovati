...
func weldCornerPlan(body *topo.Body, plan cornerWeldPlan, res tol.Resolution) (*topo.Body, string) {
...
func cornerArmWelds(plan cornerWeldPlan, res tol.Resolution) ([]cornerArmWeld, string) {
