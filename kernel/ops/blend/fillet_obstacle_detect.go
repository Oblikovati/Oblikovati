...
func rimCrossings(rim []math.Point2, b boundaryLine2, res opstol.Resolution) []crossing {
	tol := res.Weld()
	var out []crossing
	n := len(rim)
	for i := range n {
...
// mis-building.
func obstacleNodes(rim []math.Point2, b boundaryLine2, res opstol.Resolution) ([2]crossing, bool) {
