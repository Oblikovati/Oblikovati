...
func runoutOraclePatch(t *testing.T, name string, build func() (RailLoop, bool), res opstol.Resolution) geom.BSplineSurface {
	t.Helper()
	lp, ok := build()
	if !ok {
...
func runoutOracleTiling(t *testing.T, c runoutOracleCase) (setbackTiling, opstol.Resolution) {
	t.Helper()
...
func runoutOracleFillet(t *testing.T, c runoutOracleCase) (edgeFillet, opstol.Resolution) {
	t.Helper()
	...
	return fil, opstol.ForBody(body)
}
