...
// rim's own scale, so the test is scale-invariant without threading a tol.Resolution).
...
// within 1e-9 of its radius (the rim's own scale, so it is scale-invariant without threading a tol.Resolution).
