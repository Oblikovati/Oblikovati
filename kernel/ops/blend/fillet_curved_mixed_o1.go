...
func solveO1Corner(arms o1MixedArms, r float64, res opstol.Resolution) (o1Corner, bool) {
	tol := res.Weld() * r
...
func assembleO1Corner(frame o1BallFrame, arms o1MixedArms, hosts o1CornerHosts, surf o1ArmSurfaces, r float64, res opstol.Resolution) (o1Corner, bool) {
