...
func curvedClosureValid(w cornerWeld, res opstol.Resolution) bool {
...
func railsChain(w cornerWeld, res opstol.Resolution) bool {
...
func railSubtensesMatch(w cornerWeld, dirs [3]math.UnitVector3, res opstol.Resolution) bool {
	tol := res.Weld() * w.radius
	for _, a := range w.arms {
...
func sphericalClosure(dirs [3]math.UnitVector3, r float64, res opstol.Resolution) bool {
