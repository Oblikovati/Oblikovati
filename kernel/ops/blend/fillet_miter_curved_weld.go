...
func curvedMiterBody(body *topo.Body, m *cornerMiter, res opstol.Resolution) (*topo.Body, string) {
	c := m.curved
	r := c.radius()
...
func buildMiterArmSide(m *cornerMiter, arm geom.Surface, edge *topo.Edge, r float64, res opstol.Resolution) (miterArmSide, string) {
...
func assembleMiterArmSide(m *cornerMiter, arm geom.Surface, edge *topo.Edge, outer *topo.Face, farShared, farOuter math.Point3, r float64, res opstol.Resolution) (miterArmSide, string) {
...
func miterOuterRail(m *cornerMiter, arm geom.Surface, edge *topo.Edge, outer *topo.Face, farOuter, sBot math.Point3, r float64, res opstol.Resolution) (endSeg, *endSeg, bool) {
	tol := res.Weld() * r
...
func reconcileOuterRailWithTrim(railOut endSeg, run armRunout, edge *topo.Edge, arm geom.Surface, outer *topo.Face, tol float64, res opstol.Resolution) (endSeg, bool) {
