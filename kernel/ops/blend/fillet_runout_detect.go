...
// callers.
func detectRunouts(ef edgeFillet, res tol.Resolution) []runoutImprint {
...
func runoutOnHost(ef edgeFillet, host *topo.Face, hostIsA bool, res tol.Resolution) (runoutImprint, bool) {
...
func runoutOnPlane(ef edgeFillet, host *topo.Face, hostIsA bool, pl geom.Plane, fp *topo.Edge,
	res tol.Resolution) (runoutImprint, bool) {
