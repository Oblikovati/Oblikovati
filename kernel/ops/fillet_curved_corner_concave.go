...
// material, so its rolling ball sits in the VOID — PointInsideBody(centre) == false. Among the ≤8
...
func solveConcaveCurvedBlend(body *topo.Body, v *topo.Vertex, faces []*topo.Face, cyl geom.Cylinder, planes [2]*topo.Face, r float64, res Resolution) (*cornerBlend, error) {
...
func curvedCornerTangent(c math.Point3, cyl geom.Cylinder, planes [2]*topo.Face, r float64, res Resolution) bool {
