...
func canalArmRailsAndTerminal(arm edgeFillet, set armSetback, wi cornerWeld, res Resolution) (endSeg, endSeg, endSeg, bool) {
...
func canalFarTerminal(arm edgeFillet, set armSetback, wi cornerWeld, res Resolution) (endSeg, endSeg, endSeg, bool) {
...
func canalFarRail(host *topo.Face, set armSetback, railDir math.UnitVector3, ffar geom.Plane, wi cornerWeld, res Resolution, tol float64) (endSeg, bool) {
...
// misses tHost.
func torusFarRail(host *topo.Face, tor geom.Torus, tHost math.Point3, ffar geom.Plane, wi cornerWeld, res Resolution, tol float64) (endSeg, bool) {
