...
func BenchmarkLocateEdgeBSplineStrip(b *testing.B) {
	s := brepfixture.CylindricalStripSurface(b, brepfixture.BunchedStripRadius, brepfixture.BunchedStripSweep, brepfixture.BunchedStripHeight, brepfixture.BunchedStripBunch)
	body, _ := brepfixture.CylindricalStripBody(b, s, brepfixture.BunchedStripRadius, brepfixture.BunchedStripSweep, brepfixture.BunchedStripHeight)
	...
	alpha := brepfixture.BunchedStripSweep / 2
	p := math.P3(brepfixture.BunchedStripRadius*stdmath.Cos(alpha), -brepfixture.BunchedStripRadius*stdmath.Sin(alpha), brepfixture.BunchedStripHeight/2)
