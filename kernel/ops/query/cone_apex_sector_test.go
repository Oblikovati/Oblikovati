...
func TestConeApexSectorAreaOrientationIndependent(t *testing.T) {
	...
	areaUp := validate.MeshArea(tessellate.TessellateFace(fUp, ops.PropertyQuality()))
	areaDown := validate.MeshArea(tessellate.TessellateFace(fDown, ops.PropertyQuality()))
