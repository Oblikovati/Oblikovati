...
func resolveSpiricRimStations(spine spiricRimSpine, psi0 float64, res Resolution) (ellipticRimStations, geom.BSplineSurface, bool) {
...
func spiricRimWalkDirection(spine spiricRimSpine, psi0 float64, res Resolution) (float64, bool) {
