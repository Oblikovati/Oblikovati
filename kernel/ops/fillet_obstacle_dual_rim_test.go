...
func assembleDualRimRun(t *testing.T, kase dualRimCase, ef edgeFillet, res Resolution,
...
// ResolutionForPoints(d.holeSampled.pts).Weld() = 3.39411225647e-08, the DELETED test's own resolution
