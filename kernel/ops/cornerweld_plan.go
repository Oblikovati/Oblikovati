...
type cornerPlanBuilder interface {
	Plan(body *topo.Body, arms []edgeFillet, res Resolution) (cornerWeldPlan, bool, string)
}
...
func cornerWeldLayerBody(body *topo.Body, arms []edgeFillet, res Resolution) (*topo.Body, string, bool) {
