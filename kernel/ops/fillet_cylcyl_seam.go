...
func cylCylParallelValleyArmEdge(body *topo.Body, e *topo.Edge, p filletPick) (edgeFillet, bool) {
	...
	arm, ok := parallelValleyArmCylinder(e, p.r0, ResolutionForBody(body))
	if !ok {
...
func parallelValleyArmCylinder(e *topo.Edge, r float64, res Resolution) (geom.Surface, bool) {
	faces := e.Faces()
...
func resolveCylCylSeamStations(sp cylCylSeamSpine, rimP math.Point3, res Resolution) (cylCylSeamStations, geom.BSplineSurface, string) {
...
func cylCylSeamWalkDirection(sp cylCylSeamSpine, phi0, t0 float64, res Resolution) (float64, bool) {
