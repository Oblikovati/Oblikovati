...
const (
	...
	BlendKindPlate   CornerBlendKind = "plate-variational" // M6 GeomPlate port: variational fill for a tangent-degenerate valence-4 corner (RailSignatureTangentPlate)
)
