...
func torusHostCornerCenter(v *topo.Vertex, tor geom.Torus, torusFace *topo.Face, planes [2]*topo.Face, r float64, res Resolution) (math.Point3, float64, bool) {
...
func torusCornerConsistent(c math.Point3, tor geom.Torus, planes [2]*topo.Face, r, sign float64, res Resolution) bool {
...
func torusCornerResolution(v *topo.Vertex, tor geom.Torus, planes [2]*topo.Face) Resolution {
