...
func cornerArmLinks(plan cornerWeldPlan, spec cornerArmSpec, res Resolution) ([]cornerArmLink, string) {
	first := cornerArmLink{
...
func cornerArmRails(plan cornerWeldPlan, spec cornerArmSpec, links []cornerArmLink, stations []cornerArmStation, res Resolution) (cornerArmRailChain, armRunout, string) {
	last := len(links) - 1
...
func cornerArmFarRails(plan cornerWeldPlan, spec cornerArmSpec, links []cornerArmLink, near cornerArmStation, res Resolution) (endSeg, endSeg, armRunout, string) {
	last := len(links) - 1
	ef := spec.ef
...
func cornerArmLinkRails(plan cornerWeldPlan, spec cornerArmSpec, link cornerArmLink, far, near cornerArmStation, chain cornerArmRailChain, i int, res Resolution) string {
...
func cornerLinkContactRail(host *topo.Face, picked *topo.Edge, arm geom.Surface, foot0, foot1 math.Point3, res Resolution) (endSeg, bool) {
...
func sweptContactRail(host *topo.Face, picked *topo.Edge, arm geom.Surface, foot0, foot1 math.Point3, res Resolution) (endSeg, bool) {
