...
func resolveEllipticRimStations(spine ellipticRimSpine, u0 float64, res Resolution) (ellipticRimStations, geom.BSplineSurface, bool) {
...
func ellipticRimWalkDirection(spine ellipticRimSpine, u0 float64, res Resolution) (float64, bool) {
