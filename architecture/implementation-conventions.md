...
> Moved from `implementation-plan/CONVENTIONS.md`; these conventions (Definition of Done,
...
- **U (UI + e2e):** ribbon command + dialog/property window + preferences (where
  the reference platform exposes them) + an end-to-end test driving the UI to validated geometry,
